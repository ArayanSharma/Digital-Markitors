...
import eimage from "../assets/BannerImg/ShopifyDevelopment.png";
  ...
  return (
    ...
    />
      ...
      <div className="top-content">
            ...
            <p>
From corporate websites to advanced WooCommerce stores, we deliver high-performance WordPress solutions tailored for your business in Delhi NCR.
</p>          </div>
        ...
        <div className="container">
          <div className="top-content">
           <h1>
              ...
              <br />
              <span>
                with Our Affordable Website Designing Services
              </span>
            </h1>
            <p>
              Digital marketing efforts begin with a modern and beautifully
              designed website. We deliver cutting-edge web designing and
          ...
          <div className="content-grid">
            ...
            <div className="text-section">
              <h2>
                Add Value to Your Business with Our Web Design Services
              </h2>

              <p>
              Looking for the best and creative website design services with prompt delivery to give your business an edge? Make Digicore Inc. your partner in this journey. With a team of experienced and innovative minds, we offer exceptional and end-to-end web designing solutions and services at the most reasonable costs.
              </p>

              <p>
                To provide you with better, modern, creative, and engaging web solutions, our specialized team constantly work harder and meet your expectations. They keep them updated with the evolving trends so that you can stay a few steps ahead of your competitors in the market. Additionally, we consider various aspects of your particular market before offering any web solution to you.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="cms-header">
            <h2>
              ...
              <span>With The Best Tools & Builders</span>
            </h2>

            <p>
              Your website is your first ONLINE impression and your virtual face, it has to be appealing and eases in navigation. To retain the trust of your customers, it is mandatory to choose your CMS carefully as it ensures the performance of your website.
            </p>
          </div>
  ...
  <div className="container">
    <div className="work-header">
      ...
      <p>
        Digital Markitor’s website designing team has had the great pleasure of working with various high-profile and well-known clients across a varied mix of verticals
      </p>
    </div>
