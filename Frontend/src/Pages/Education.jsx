...
import eimage from "../assets/BannerImg/eduction2.png";
...
From Google, Instagram and YouTube to markeplaces like Amazon and Flipkart, consumers are searching everywhere, and that's why it is important for your brand to be visible everywhere.
  ...
  <div className="seo-container">
    ...
    <div className="seo-heading">
      ...
      <h2>
Why Do I Need an Healthcare SEO Agency</h2>
<p>Digicore Inc. is a 360 digital marketing agency in Delhi that is dedicated to helping brands develop, engage, and lead, while also supporting the success of your business. Over the years, we've been at the forefront of driving digital transformation through creativity, strategy, and technology to meet our clients' impactful requirements.</p>
    </div>
