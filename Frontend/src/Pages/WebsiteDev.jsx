...
import eimage from "../assets/BannerImg/webDevelopmenet.png";
  ...
  return (
    ...
    />
      ...
      <div className="top-content">
            <h1>
              What Kind Of <strong>Website Do You Need?</strong>
              
             
            </h1>

            <p>
              Count on Digicore Inc., if you are looking for cost-effective website designing and development services in India. We specialize in both dynamic and static yet SEO-friendly websites. So, look no further when we are here to provide you with the right combination of expertise, skills, and knowledge to design a website that exceeds your expectations.
            </p>
          </div>
        ...
        <div className="container">
          ...
          <div className="content-grid">
            ...
            <div className="text-section">
              ...
              <p>
                Looking for the best and creative website design services with
                prompt delivery to give your business an edge? Make Digital
                Markitors your partner in this journey.
              </p>

              <p>
                Our specialized team constantly works harder and keeps up with
                evolving trends so that you stay ahead of competitors.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="cms-section">
        <div className="container">
          <div className="cms-header">
            <h2>
              Choose CMS that{" "}
              <span>Best Fits Your Web Designing Needs</span>
            </h2>

            <p>
              Your website is your first online impression and your virtual
              face. It has to be appealing and easy to navigate.
            </p>
          </div>
